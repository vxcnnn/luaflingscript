...
local function MinimizeButtonScript() -- MinimizeButton.LocalScript
	...
	minimizeButton.MouseButton1Click:Connect(function()
		if frame.Size == UDim2.new(0, 148, 0, 106) then
			frame.Size = UDim2.new(0, 148, 0, 0)
		else
			frame.Size = UDim2.new(0, 148, 0, 106)
		end
	end)
end
coroutine.wrap(MinimizeButtonScript)()
